...
package com.JTechMod.custom.refreshlayout;
...
public class RefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
     ...
     *
     * @param scale Set to true if there is no view at a higher z-order than where
    ...
    public void startRefreshing() {
        ...
        moveSpinner(mTotalDragDistance);
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
        // If we are in the middle of consuming, a scroll, then we want to move
        // the spinner back up
